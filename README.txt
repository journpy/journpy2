...
working primarily with Python but also uses other languages from time to time. 
Uchenna is an active contributor on Stack Oveflow - the number one Q/A site
for developers looking for help to technical problems.